defmodule Websocket.Message.Cast do
  @moduledoc """
  ...
  defmacro __using__(opts) do
    ...
    quote do
      ...
      @behaviour Websocket.Message.Cast
      ...
      @after_compile Websocket.Message.Cast
    end
  end
  ...
  @callback changeset(struct | nil, Websocket.json()) :: Ecto.Changeset.t()
