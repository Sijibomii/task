defmodule Websocket.Message.Call do
  @moduledoc """
  ...
  ```elixir
  using Websocket.Message.Call, reply: <module>
  ```
  ...
  defmacro __using__(opts) do
    ...
    quote do
      ...
      @behaviour Websocket.Message.Call
      ...
      @after_compile Websocket.Message.Call
    end
  end

  alias Ecto.Changeset
  alias Websocket.SocketHandler
