...
var connect = function (token, refreshToken, _a) {
    ...
    return new Promise(function (resolve, reject) {
                ...
                var connection_1 = {
                    ...
                    sendCall: function (opcode, parameters, doneOpcode) {
                        return new Promise(function (resolveCall, rejectFetch) {
                            ...
                            var ref = !doneOpcode && (0, uuid_1.v4)();
                            var timeoutId = null;
                            ...
                            apiSend(opcode, parameters, utils_1.opcodeToTopicMapping[opcode], ref || undefined);
                        });
                    },
                };
        ...
        socket.addEventListener("open", function () {
            ...
            apiSend("auth", __assign({ accessToken: token, refreshToken: refreshToken }, getAuthOptions === null || getAuthOptions === void 0 ? void 0 : getAuthOptions()), utils_1.opcodeToTopicMapping.auth);
        });
    });
};
